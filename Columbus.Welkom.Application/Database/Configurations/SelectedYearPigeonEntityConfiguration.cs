...
public class SelectedYearPigeonEntityConfiguration : IEntityTypeConfiguration<SelectedYearPigeonEntity>
{
    public void Configure(EntityTypeBuilder<SelectedYearPigeonEntity> builder)
    {
        builder.ToTable("selected_year_pigeon");
